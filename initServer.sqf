 ...
 */
 [] spawn {
 [getPosATL Start1, getPosATL End1, 50, "FULL", "CUP_O_Mi8AMT_RU", east] call BIS_fnc_ambientFlyby;
  [getPosATL Start2, getPosATL End2, 50, "FULL", "CUP_O_Mi8AMT_RU", east] call BIS_fnc_ambientFlyby;
 };
